...
// Headers das funções definidas pelo professor Eduardo
#include "funcoes_prof.h"

// Função que carrega uma imagem para ser utilizada como textura
void LoadTextureImage(const char* filename, GLuint& g_NumLoadedTextures)
{
...
void DrawVirtualObject(const char* object_name, std::map<std::string, SceneObject>& g_VirtualScene)
{
...
//
void LoadShadersFromFiles(SHADERS_DEFINITIONS& shaders)
{
    ...
    if ( shaders.g_GpuProgramID != 0 )
        glDeleteProgram(shaders.g_GpuProgramID);

    // Criamos um programa de GPU utilizando os shaders carregados acima.
    shaders.g_GpuProgramID = CreateGpuProgram(vertex_shader_id, fragment_shader_id);
...
void BuildTrianglesAndAddToVirtualScene(ObjModel* model, std::map<std::string, SceneObject>& g_VirtualScene)
{
